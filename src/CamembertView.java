...
public static void main(String[] a) {
		...
		//Adjusts the window to the size of the user's screen
		window.setSize(Toolkit.getDefaultToolkit().getScreenSize());
		
		// Create an instance of the model
        CamembertModel camModel = new CamembertModel("test");
        
        // Maybe put some data in the model
		int oldFirst = 0;
		int oldLast = 0;
		
		camModel.addItem("Food", "a man's gotta eat", 80.00);
		camModel.addItem("Garage", "car repairs", 130.00);
		camModel.addItem("Dogs", "dog food and vet bills", 60.00);

		// Create the controller and the view and link all together
		//making a view sets attribute model equal to camModel
		CamembertView view = new CamembertView(camModel);
		view.controller = new Controller(camModel);
		
		//Connects the window with our mouse listener.
